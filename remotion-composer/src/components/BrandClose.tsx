 ...
 * puntual) — confirmado en produccion: `caso-real-medicina-estetica-v1.mp4`
 * y `lo-que-cambia-en-tu-clinica-v1.mp4` de ESTA serie lo tenian. Se
 * arregla en la RAIZ (maxWidth + textAlign, igual que ya hacia `tagline`)
 * en vez de acortar el copy de cada CTA como parche. Ver P-13 en
 * `Video-problemas.md`.
 */
